...
This is a one-shot repository maintenance helper. It fails closed unless every
reviewed source anchor occurs exactly once.
"""
...
EXPECTED_SHA256 = "a9f9f0fc0995f2d2a8f93e9ce3302d2542afd3bb"
...
def main() -> int:
    ...
    text = replace_once(
        ...
        '        (\n            FINALIZE_BLOCK,\n',
        tuple_entries + '        (\n            FINALIZE_BLOCK,\n',
        "ELF-confirmed guide-window replacement entries",
    )
    ...
    text = replace_once(
        ...
        "stable 23-path historical delta set",
    )
    text = replace_once(
        text,
    ...
    text = replace_once(
        ...
        "header-prototype evidence flag",
    )
